    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <p>Voici la liste des films que j'aime et qui sont sortis récemment au cinéma. Nous sommes actuellement
                    en train de déployer notre site web sur Azure...</p>
            </div>
            <?php if (count($data) > 1): ?>
            ...
            <?php else: ?>
            <h2>Il n'y a pas de film actuellement disponible.</h2>
            <?php endif; ?>
        </div>
    </body>
</html>
